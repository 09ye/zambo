package com.mobilitychina.crash;
...
import com.mobilitychina.util.MainUILooperDelegate;
 ...
 * 
 */
public class CrashHandler implements UncaughtExceptionHandler, ITaskListener {

	public static final String TAG = "CrashHandler";
	private String path = "/data/data/"+MobilityChinaApplication.instance().getPackageName()+"/crash/";
	...
	private SoapTask getSenderTask(String exception) {
		...
		SoapTask task = new SoapTask(mContext);
		...
		task.setSoapMethod("saveExceptions");

		ArrayList<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("arg0", exception));
